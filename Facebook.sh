...
echo $i" |"$cy"     INTERNET IS AWESOME BUT I CANT DOWNLOAD LOVE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" A'initial  [SEMARANG CREW]"$i"                 |"
echo $i" |"$pu" FACEBOOK :"$ku" Mas Al voltHz"$i"                            |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Z-vector] [ErikGayn] [PakPung][AhmadR]"$i"|"
echo $i" |"$cy"        ~ [sibelclem] [%CongyanGoyanG%] [OTOMOTIF]"$i"        |"
echo $i" |"$pu" Contact WhatsApp :"$ku" 085101970588"$i"                     |"
echo $i" |"$pu" Note :"$ku" Jangan Hubungi Saya :V"$i"                       |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo $me"┌==="$bi"["$i"JATIM BLACKHAT"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 081390222593"
echo $ku"Facebook :"$i" Mas Al voltHz"
sleep 2
