...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" A'initial  [JATIM BLACKHAT]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Mas Al voltHz"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Mr.XiD] [Mr.Fanx52] [Mr.D1CK]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%CongyanGoyanG%] [Salam Seduluran]"$i" |"
echo $i" |"$pu" Contact WhatsApp :"$ku" 081390222593"$i"             |"
